...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	// регистр ОстаткиТоваров и ПартииТоваров Приход
	...
	Для Каждого ТекСтрокаСписокТоваров Из СписокТоваров Цикл
		...
		ДвижениеПУ.ВидДвижения = ВидДвиженияНакопления.Приход;
		ДвижениеПУ.Период = Дата;		
		ДвижениеПУ.Партия = ЭтотОбъект.Ссылка;
		ДвижениеПУ.Товар = ТекСтрокаСписокТоваров.Товар;		
		ДвижениеПУ.Количество = ТекСтрокаСписокТоваров.Количество;	
	КонецЦикла;
